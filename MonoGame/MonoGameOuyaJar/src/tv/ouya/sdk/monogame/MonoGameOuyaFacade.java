...
public class MonoGameOuyaFacade
{
    ...
    private static final String LOG_TAG = "MonoGameOuyaFacade";
	...
	*/
	...
	public MonoGameOuyaFacade(Context context, Bundle savedInstanceState, String developerId, byte[] applicationKey)
	{
		try
		{
