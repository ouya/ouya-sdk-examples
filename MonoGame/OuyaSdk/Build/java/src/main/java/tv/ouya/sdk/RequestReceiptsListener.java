...
public class RequestReceiptsListener implements OuyaResponseListener<Collection<Receipt>>
{
	private static final String TAG = RequestReceiptsListener.class.getSimpleName();
