...
void SetContentClient(ContentClient* client) {
  ...
  if (client) {
    ...
    webkit_glue::SetUserAgent("Mozilla/5.0 (Linux; Android 4.1.2;) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/19.77.34.5 Safari/537.36, OUYA Console Build/JZO54L-OUYA, OUYA/1.0.10 (OUYA, JZO54L-OUYA, Wireless)", false);
  }
}
