...
private static final String TAG = "ImeAdapter";
    ...
    void sendKeyEventWithKeyCode(int keyCode, int flags) {
        //Log.i(TAG, "sendKeyEventWithKeyCode keyCode="+keyCode);
    ...
    boolean checkCompositionQueueAndCallNative(String text, int newCursorPosition,
        ...
        //Log.i(TAG, "checkCompositionQueueAndCallNative keyCode="+keyCode);
    ...
    boolean translateAndSendNativeEvents(KeyEvent event) {
        //Log.i(TAG, "translateAndSendNativeEvents keyCode="+event.getKeyCode()+" action=" + event.getAction());
        if (mNativeImeAdapterAndroid == 0) return false;
        ...
        //Log.i(TAG, "nativeSendKeyEvent keyCode="+event.getKeyCode()+" action=" + event.getAction());
    ...
    boolean sendSyntheticKeyEvent(
        ...
        //Log.i(TAG, "sendSyntheticKeyEvent keyCode="+keyCode);
