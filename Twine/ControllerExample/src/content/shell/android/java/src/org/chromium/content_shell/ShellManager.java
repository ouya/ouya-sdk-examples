...
public class ShellManager extends FrameLayout {
    ...
    public static final String DEFAULT_SHELL_URL = "about:blank";
    ...
    public void showToolbar() {
        if (null != mActiveShell) {
            mActiveShell.showToolbar();
        }
    }
    public void hideToolbar() {
        if (null != mActiveShell) {
            mActiveShell.hideToolbar();
        }
    }

    public void requestRenderViewFocus() {
        if (null != mActiveShell) {
            mActiveShell.requestRenderViewFocus();
        }
    }

    public double getProgress() {
        if (null != mActiveShell) {
            return mActiveShell.getProgress();
        }
	return 0.0;
    }
}
