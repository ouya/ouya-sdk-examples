        ...
        },
        {
          ...
          'variables': {
            ...
            'additional_input_paths': ['<(PRODUCT_DIR)/content_shell/assets/content_shell.pak',
              'shell/android/shell_apk/res/drawable/app_icon.png',
              'shell/android/shell_apk/res/drawable-xhdpi/ouya_icon.png',
              ],
            'asset_location': '<(PRODUCT_DIR)/content_shell/assets',
            'input_jars_paths': ['/home/ouyadev/Downloads/android-studio/sdk/platforms/android-19/android.jar',
              'shell/android/shell_apk/libs/ouya-sdk.jar'],
          },
          'conditions': [
