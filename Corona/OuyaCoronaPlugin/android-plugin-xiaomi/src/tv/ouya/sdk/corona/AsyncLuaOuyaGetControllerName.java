 ...
 */
public class AsyncLuaOuyaGetControllerName implements com.naef.jnlua.NamedJavaFunction {
	/**
	...
	public String getName() {
		return "asyncLuaOuyaGetControllerName";
	}
	...
	public int invoke(com.naef.jnlua.LuaState luaState) {
		...
		CallbacksGetControllerName callbacks = new CallbacksGetControllerName(luaState);
