 ...
 */
public class LuaOuyaGetDeviceHardwareName implements com.naef.jnlua.NamedJavaFunction {

	private static final String TAG = LuaOuyaGetDeviceHardwareName.class.getSimpleName();
	...
	public int invoke(final com.naef.jnlua.LuaState luaState) {
		...
		String result = CoronaOuyaPlugin.getDeviceHardwareName();
		if (null == result) {
			luaState.pushString("");
			return 1;
		}
